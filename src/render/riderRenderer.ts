 ...
 * experiment (Phase 7) stays a config flag, not a rewrite. The code-drawn path is
 * the production default; the sprite implementation remains available internally.
 */
